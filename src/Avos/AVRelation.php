...
use Avos\Internal\AVRelationOperation;

/**
 * AVRelation - A class that is used to access all of the children of a many-to-many relationship. Each instance
...
class AVRelation {
    ...
    /**
     * @var AVObject - The parent of this relation.
     */
    private $parent;
    /**
     ...
     *
     * @param AVObject $parent The parent of this relation.
    ...
    /**
     * Adds a AVObject or an array of AVObjects to the relation.
     *
    ...
    public function add($objects)
    {
        ...
        $operation = new AVRelationOperation($objects, null);
        $this->targetClassName = $operation->_getTargetClass();
        $this->parent->_performOperation($this->key, $operation);
    }

    /**
     * Removes a AVObject or an array of AVObjects from this relation.
     *
    ...
    public function remove($objects)
    {
        ...
        $operation = new AVRelationOperation(null, $objects);
        $this->targetClassName = $operation->_getTargetClass();
        $this->parent->_performOperation($this->key, $operation);
    }
     ...
     *
     * @return AVQuery That restricts the results to objects in this relations.
     */
    public function getQuery()
    {
        $query = new AVQuery($this->targetClassName);
